...
class GUI(tk.Frame):
    def __init__(self, parent = None):
        ...
        self.com_text.insert(0, "variation/linux-full-walk")
        self.com_text.pack()
        ...
        self.ip_text.insert(0, "8.12.0.200")
        self.ip_text.pack()
        ...
        self.thresh_text.insert(0, "22, 20, 18")
        ...
        self.oids = {"CPUload":"1.3.6.1.2.1.25.3.3.1.2.768","RAM":"1.3.6.1.4.1.2021.4.6.0","DISCO": "1.3.6.1.2.1.1.3.0"}
